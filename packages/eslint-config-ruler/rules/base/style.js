module.exports = {
  rules: {
    ...
    // 大括号风格要求：one true brace style 风格，单行代码块不换行
    ...
    // 强制只能使用函数声明或函数表达式 ['off', 'expression'],
    'func-style': 'off',
    ...
    // 在函数 (var) 或块 (let 和 const) 范围使用多个声明并分开
    'one-var': ['error', 'never'],
